...
class HabitatDataset(GradSLAMDataset):
    def __init__(
        ...
        desired_height: Optional[int] = 640,
        desired_width: Optional[int] = 480,
    ...
    def get_filepaths(self):
        ...
        pose_list = os.path.join(self.input_folder, 'poses.txt')
        image_list = os.path.join(self.input_folder, 'rgb_list.txt')
        depth_list = os.path.join(self.input_folder, 'depth_list.txt')
